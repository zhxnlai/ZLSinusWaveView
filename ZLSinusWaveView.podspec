#
#  Be sure to run `pod spec lint ZLSinusWaveView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Zhixuan Lai"
  # s.authors            = { "Zhixuan Lai" => "zhxnlai@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Zhixuan Lai"
